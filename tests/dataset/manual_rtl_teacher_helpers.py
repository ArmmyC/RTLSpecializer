...
def evidence_for_plan(run: Path, *, accepted: bool = False) -> Path:
    ...
    evidence = {
        ...
        "mismatch_summary": {"contract": "mismatch_count_v1", "reported_counts": [0 if accepted else 1], "reported_sample_counts": [20 if accepted else 1], "maximum_count": 0 if accepted else 1, "timeout_reported": False},
