...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--teacher-generation-binding", type=Path)
    parser.add_argument("--repair-binding", type=Path)
    ...
    report, code = prepare_candidate_verification(
        ...
        teacher_generation_binding_path=args.teacher_generation_binding,
        repair_binding_path=args.repair_binding,
    )
    if args.json:
